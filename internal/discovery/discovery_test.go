...
func TestTechnologyDetectorAndRoleGenerator(t *testing.T) {
	tests := []struct {
		...
		{name: "android compose", files: map[string]string{"app/build.gradle.kts": `plugins { id("com.android.application") } android { buildFeatures { compose = true } } dependencies { implementation("androidx.compose.ui:ui") }`}, languages: []string{"Kotlin"}, technologies: []string{"Android", "Jetpack Compose"}, roles: []string{"android-test", "android-ui"}},
		...
		{name: "go module", files: map[string]string{"go.mod": "module example.com/project\n\ngo 1.24\n"}, languages: []string{"Go"}},
